"""
Django settings for winimarket_app project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'www.winimarketgh.shop', 'winimarketgh.shop', "winimarket-628170763833.us-central1.run.app", ".run.app"]
...
ROOT_URLCONF = 'winimarket_app.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication',    # for API clients (postman, frontend)
    ],
